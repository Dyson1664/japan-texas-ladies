...
const TERMS_SECTIONS = [
  ...
  },
  {
    ...
    content: [
      ...
      "IBT’s liability is limited to amounts paid directly to Imagine Beyond Travel for tour land services only. No refunds are issued for flights, insurance, or third-party services not paid directly to IBT.",
