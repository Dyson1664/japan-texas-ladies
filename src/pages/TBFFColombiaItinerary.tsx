...
import { colombiaData } from "@/data/countries/colombia";
import TBFFFooter from "@/components/common/TBFFFooter";

const TBFFColombiaItinerary = () => {
  ...
  return (
    <div className="tbff-theme">
      ...
      `}</style>
      <ItineraryTemplate data={colombiaData} logoStyle={tbffLogoStyle} FooterComponent={TBFFFooter} />
    </div>
  );
};

export default TBFFColombiaItinerary;
